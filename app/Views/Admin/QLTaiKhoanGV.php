...
<body>
    ...
    <div class="page-container">
        ...
        <h1 class="main-page-title">QUẢN LÝ giảng viên</h1>
        ...
        <div class="custom-card">
            ...
            <div class="toolbar-container mb-4">
                ...
                <div class="toolbar-left">
                    <div class="toolbar-title">
                        <i class="bi bi-building-fill me-2"></i> <span>Danh sách tài khoản giảng viên</span>
                    </div>
                </div>

                <div class="toolbar-right d-flex align-items-center gap-3">
                    <a <?php echo isset($_GET['search']) ? '' : 'style="display:none;"'; ?> href="Admin/QuanLyTaiKhoan/GiangVien">Hủy tìm kiếm</a>
                    <form action="" method="GET" class="search-wrapper position-relative">
                        <input type="search" name="search" class="form-control search-input" value="<?php echo isset($_GET['search']) ? $_GET['search'] : '' ?>" placeholder="Tìm kiếm giảng viên...">
            ...
            <div class="custom-table">
                <div class="table-header">
                    <div class="col-cell c-code">Mã giảng viên</div>
                    <div class="col-cell c-ho">Họ</div>
                    <div class="col-cell c-ten">Tên</div>
                    <div class="col-cell c-lop">Khoa</div>
                ...
                <div class="table-body">
                    <?php foreach ($data['listGV'] as $sv): ?>
                        <div class="table-row">
                            <div class="col-cell c-code"><?php echo htmlspecialchars($sv['MaGV']); ?></div>
                            <div class="col-cell c-ho"><?php echo htmlspecialchars($sv['Ho']); ?></div>
                            <div class="col-cell c-ten"><?php echo htmlspecialchars($sv['Ten']); ?></div>
                            <div class="col-cell c-lop"><?php echo htmlspecialchars($sv['TenKhoa']); ?></div>
                            ...
                            <div class="col-cell c-action">
                                <a href="Admin/QuanLyTaiKhoan/GiangVien/SuaGiangVien?MaGV= <?php echo htmlspecialchars($sv['MaGV']) ?>" class="btn-icon btn-edit" title="Sửa"><i class="bi bi-pencil-square"></i>Sửa </a>
                                <a onclick="return confirm('Bạn chắc chắn muốn xóa giảng viên này, mọi dữ liệu liên quan cũng sẽ bị xóa?')" href="Admin/QuanLyTaiKhoan/GiangVien/XoaGiangVien?MaGV= <?php echo htmlspecialchars($sv['MaGV']) ?>" class="btn-icon btn-delete" title="Xóa"><i class="bi bi-trash"></i>Xóa</a>
                            </div>
