            ...
            <form method="POST" action="">
                <div class="form-group-row">
                    ...
                    <div class="form-account-input">
                        ...
                        <input type="text" name="CCCD" required placeholder="Nhập số CCCD" value="<?php echo (isset($studentData)) ? $studentData['CCCD'] : '' ?>">
                    </div>
                </div>
                ...
                <div class="form-group-row">
                    ...
                    <input type="date" name="NgaySinh" required placeholder="Nhập ngày sinh" value="<?php echo (isset($studentData)) ? $studentData['NgaySinh'] : '' ?>">
                    </div>
                    <div class="form-account-input">
                        ...
                        <select name="GioiTinh" class="form-select" required>
                            <option value="Nam" <?php echo (isset($studentData) && $studentData['GioiTinh'] == 'Nam') ? 'selected' : '' ?>>Nam</option>
                            <option value="Nữ" <?php echo (isset($studentData) && $studentData['GioiTinh'] == 'Nữ') ? 'selected' : '' ?>>Nữ</option>
                ...
                <?php else: ?>
                    <a style="width: fit-content;" href="Admin/ResetMatKhau?StudentID=<?php echo $studentData['MSSV'] ?>" class="btn btn-submit">Reset mật khẩu</a>
                <?php endif; ?>
                ...
                <div class="form-group-row">
                    ...
                    <div class="form-account-input">
                        ...
                        <input type="text" name="SoDT" required placeholder="Nhập số điện thoại" value="<?php echo (isset($studentData)) ? $studentData['SoDT'] : '' ?>">
                    </div>
                    ...
                    <div class="form-account-input">
                        ...
                        <input type="text" name="DiaChi" required placeholder="Nhập địa chỉ" value="<?php echo (isset($studentData)) ? $studentData['DiaChi'] : '' ?>">
                    </div>
