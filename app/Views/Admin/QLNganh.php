...
<html lang="vi">
<head>
    <link rel="stylesheet" href="public/assets/css/qlnganh.css">
</head>
<body>
        ...
        <div class="custom-card">
            ...
            <div class="toolbar-container mb-4">
                ...
                <div class="toolbar-right d-flex align-items-center gap-3">
                    <a <?php echo isset($_GET['search']) ? '' : 'style="display:none;"'; ?> href="Admin/QuanLyHeThong/Nganh">Hủy tìm kiếm</a>
                    ...
                    <a href="Admin/QuanLyHeThong/Nganh/ThemNganh" class="btn btn-primary btn-add">
            ...
            <div class="select-box-container">
                    ...
                    <select class="form-select" onchange="window.location.href = 'Admin/QuanLyHeThong/Nganh?KhoaID='+ this.value" id="luaChon" aria-label="Ví dụ chọn đáp án">
                ...
                <div class="table-body">
                    ...
                    <div class="table-row">
                        ...
                        <div class="col-cell c-action">
                            <a href="Admin/QuanLyHeThong/Nganh/SuaNganh?NganhID=<?php echo htmlspecialchars($nganh['MaNganh']); ?>" class="btn-icon btn-edit" title="Sửa"><i class="bi bi-pencil-square"></i>Sửa </a>
                            <a onclick="return confirm('Bạn chắc chắn muốn xóa ngành này, mọi dữ liệu liên quan cũng sẽ bị xóa?')" href="Admin/QuanLyHeThong/Nganh/XoaNganh?NganhID=<?php echo htmlspecialchars($nganh['MaNganh']); ?>" class="btn-icon btn-delete"  title="Xóa"><i class="bi bi-trash"></i>Xóa</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
