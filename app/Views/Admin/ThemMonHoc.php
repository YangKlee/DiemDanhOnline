<div class="qnu-form-container" style="max-width: 600px; margin: 40px auto; padding: 20px; border: 1px solid #dee2e6; border-radius: 8px; background-color: #f8f9fa; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <form class="qnu-course-form" method="post" >
        <div class="qnu-course-form__group" style="margin-bottom: 15px;">
            ...
            <input type="text" name="MaMon" id="maMonHoc" class="form-control qnu-course-form__input" placeholder="Ví dụ: COMP123" style="border-color: #adb5bd;">
        </div>

        <div class="qnu-course-form__group" style="margin-bottom: 15px;">
            <label for="tenMonHoc" class="qnu-course-form__label" style="display: block; font-weight: 600; margin-bottom: 5px;">Tên môn học:</label>
            <input type="text" name="TenMon" id="tenMonHoc" class="form-control qnu-course-form__input" placeholder="Ví dụ: Lập trình Web" style="border-color: #adb5bd;">
        </div>

        <div class="qnu-course-form__group" style="margin-bottom: 15px;">
            <label for="soTinChi" class="qnu-course-form__label" style="display: block; font-weight: 600; margin-bottom: 5px;">Số tín chỉ:</label>
            <input type="number" id="soTC" class="form-control qnu-course-form__input" min="1" max="10" style="border-color: #adb5bd;">
        </div>
        ...
        <div class="qnu-course-form__group" style="margin-bottom: 25px;">
            ...
            <select name="MaKhoa" id="khoaPhuTrach" class="form-select qnu-course-form__select" style="border-color: #adb5bd; cursor: pointer;">
        ...
        <div class="qnu-course-form__actions" style="display: flex; gap: 10px; justify-content: flex-end;">
            <button type="reset" class="btn btn-secondary qnu-course-form__button--reset" style="padding: 8px 20px;">Hủy</button>
            <button type="submit" class="btn btn-primary qnu-course-form__button--submit" style="padding: 8px 25px; background-color: #0d6efd; border: none;">Lưu môn học</button>
        </div>
    </form>
</div>